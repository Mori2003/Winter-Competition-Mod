...
public class CozyCabinFeature extends StructureFeature<DefaultFeatureConfig> {
  public CozyCabinFeature(Codec<DefaultFeatureConfig> codec) {
      super(codec);
    }
    ...
    public static class Start extends StructureStart<DefaultFeatureConfig> {
      ...
      public void init(DynamicRegistryManager registryManager, ChunkGenerator chunkGenerator, StructureManager manager, int chunkX,
        ...
        int x = chunkX * 16;
        int z = chunkZ * 16;
        int y = chunkGenerator.getHeight(x, z, Heightmap.Type.WORLD_SURFACE);
        //sets spawn altitude
        //y = 58;
        //
        BlockPos pos = new BlockPos(x, y, z);
        BlockRotation rotation = BlockRotation.random(this.random);
        CozyCabinStructure.addPieces(manager, pos, rotation, this.children);
