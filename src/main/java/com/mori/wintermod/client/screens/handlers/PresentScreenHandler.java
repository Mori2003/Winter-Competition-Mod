package com.mori.wintermod.client.screens.handlers;
...
public class PresentScreenHandler extends ScreenHandler {
    ...
    private static final int INVENTORY_SIZE = 9; // 6 rows * 9 cols
    ...
    public PresentScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory) {
        super(WinterModScreenHandlers.PRESENT_SCREEN_HANDLER, syncId);
